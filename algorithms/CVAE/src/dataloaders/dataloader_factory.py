from algorithms.CVAE.src.dataloaders.CIFAR10_Dataloader import CIFAR10_Test_Dataloader, CIFAR10Dataloader
from algorithms.CVAE.src.dataloaders.MNIST_Dataloader import MNIST_Test_Dataloader, MNISTDataloader
