...
from algorithms.CVAE.src.dataloaders import dataloader_factory
from algorithms.CVAE.src.models import model_factory
...
class Trainer_CVAE:
    def __init__(self, args, device, exp_idx):
        ...
        self.vae = CVAE(x_dim=self.args.feature_dim, h_dim1=512, h_dim2=256, z_dim=2, c_dim = self.args.n_classes).to(self.device)
    ...
    def estimate_density(self):
        ...
        for iteration in range(self.args.density_estimation_iterations):
            ...
            recon_batch, mu, log_var = self.vae(latents.detach(), labels)
