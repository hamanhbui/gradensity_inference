...
# tensorboard --logdir "/data/habui/gradensity_inference/algorithms/ERM/results/tensorboards/Rotated_75_MNIST_0"

# rm -r algorithms/ERM/results/checkpoints/*
# rm -r algorithms/ERM/results/logs/*
# rm -r algorithms/ERM/results/plots/MNIST_0/*
# rm -r algorithms/ERM/results/plots/Rotated_75_MNIST_0/*
# rm -r algorithms/ERM/results/tensorboards/MNIST_0/*
# rm -r algorithms/ERM/results/tensorboards/Rotated_75_MNIST_0/*

python main.py --config "algorithms/ERM/configs/MNIST.json" --exp_idx "0" --gpu_idx "0"
python main.py --config "algorithms/ERM/configs/Rotated_75_MNIST.json" --exp_idx "0" --gpu_idx "0"
